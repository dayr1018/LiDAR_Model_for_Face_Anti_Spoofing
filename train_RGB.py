...
# from data.dataloader_RGB_Depth import load_cisia_surf, CISIA_SURF
...
parser.add_argument('--save-path', default='../output/RGB/logs/Train/', type=str, help='logs save path')
...
if __name__ == '__main__':
    ...
    if args.skf == 0:
        ...
        for fold, (train_idx, test_idx) in enumerate(skf.split(dataset, nparr_label)):
            ...
            weight_dir = '/mnt/nas3/yrkim/liveness_lidar_project/GC_project/output/RGB/checkpoint/checkpoint_v' + str(args.mode) + '_0/global_min_acer_model.pth'
            test(fold=fold, epoch="global", data_loader=test_loader, weight_dir=weight_dir)            
            weight_dir = '/mnt/nas3/yrkim/liveness_lidar_project/GC_project/output/RGB/checkpoint/checkpoint_v' + str(args.mode) + '_0/Cycle_49_min_acer_model.pth'
