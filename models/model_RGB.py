...
class Model(nn.Module):
    def __init__(self,pretrained=False, num_classes=2):
        ...
        ## 내가 만든 거
        self.rgb_layer4 = self.rgb_resnet.layer4
        self.rgb_selayer4 = SElayer(512)
    ...
    def forward(self, rgb_img):
        ...
        rgb_feat4 = self.rgb_layer4(rgb_feat3)
        rgb_feat4 = self.rgb_selayer4(rgb_feat4)

        # print(rgb_feat4.shape)
        rgb_feat4 = self.avg_pool(rgb_feat4)
        rgb_fc = rgb_feat4.view(rgb_feat4.size(0), -1)
                
        # print("rgb_feat4==> " + str(rgb_feat4.shape))
        # print("rgb_fc==> " + str(rgb_fc.shape))
        out = self.fc(rgb_fc)
