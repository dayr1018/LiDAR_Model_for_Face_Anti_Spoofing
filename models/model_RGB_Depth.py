...
class Model(nn.Module):
    ...
    def forward(self, rgb_img, depth_img):
        ...
        fusion_feat1 = self.mwb1(rgb_feat1,depth_feat1,None)
        fusion_feat2 = self.mwb2(rgb_feat2,depth_feat2,fusion_feat1)
        fusion_feat3 = self.mwb3(rgb_feat3,depth_feat3,fusion_feat2)
...
class MWB(nn.Module):
    def __init__(self, in_planes=64, out_plane=128,layer=1):
        ...
        self.layer = layer
        if self.layer == 1:
            cf_planes = 2*in_planes
            fc = 2
        else:
            cf_planes = 3*in_planes
            fc = 3
    ...
    def forward(self, rgb_feat, depth_feat, new): 
