...
parser.add_argument('--save-path', default='../output/RGB/logs/Test/', type=str, help='logs save path')
...
if __name__ == '__main__':
    ...
    for i in range(50):
        if (i+1) % 10 == 0:
            local_dir = '/mnt/nas3/yrkim/liveness_lidar_project/GC_project/output/RGB/checkpoint/checkpoint_v' + str(args.mode) + '_0/' +'Cycle_' + str(i) + '_min_acer_model.pth'
