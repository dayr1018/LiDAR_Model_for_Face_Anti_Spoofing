...
with open(Train_File, 'w') as file:
    for subNum in range(Train_Start,Train_End):
        ...
        for fileNum in range(facedata_start, facedata_end):
            file.write(f"LDFAS/{subNum}/attack_replay/rgb_{fileNum}.jpg LDFAS/{subNum}/attack_replay/depth_{fileNum}.jpg LDFAS/{subNum}/attack_replay/pc_{fileNum}.ply 0\n")    
