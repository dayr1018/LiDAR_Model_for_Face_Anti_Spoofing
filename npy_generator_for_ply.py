...
if __name__ == "__main__":
    ...
    for i in person_number :
        if not osp.exists(osp.join(save_path, 'real_cloud_data',str(i))) :
            os.makedirs(osp.join(save_path, 'real_cloud_data',str(i)))
    for i in person_number :
        if not osp.exists(osp.join(save_path, 'mask_cloud_data',str(i))) :
            os.makedirs(osp.join(save_path, 'mask_cloud_data',str(i)))
    for i in person_number :
        if not osp.exists(osp.join(save_path, 'replay_cloud_data',str(i))) :
            os.makedirs(osp.join(save_path, 'replay_cloud_data',str(i)))
    for i in person_number :
        if not osp.exists(osp.join(save_path, 'paper_cloud_data',str(i))) :
            os.makedirs(osp.join(save_path, 'paper_cloud_data',str(i)))

    # bonafide
    for i in tqdm(person_number) :
        num_path = osp.join(data_path,str(i))
    ...
    #             proj_depth[int(real[k, 3]), int(real[k, 4])] = real[k, 5]
            ...
            save_name = osp.join(save_path, 'real_cloud_data',str(i),j.split('.')[0]+'.npy')
    ...
    for i in person_number :
        ...
        new_path = osp.join(save_path, 'real_cloud_data', str(i))
    ...
    for i in tqdm(person_number) :
        ...
        for j in files : 
            ...
            save_name = osp.join(save_path, 'mask_cloud_data',str(i),j.split('.')[0]+'.npy')
            np.save(save_name, proj_xyzd)
    ...
    for i in person_number :
        ...
        new_path = osp.join(save_path, 'mask_cloud_data', str(i))
        new_files = os.listdir(new_path)
        print(i,f' Org Data Count : {len(org_files)}  New Data Count : {len(new_files)} ==> {len(org_files)==len(new_files)}')
    ...
    for i in tqdm(person_number) :
        ...
        for j in files : 
            ...
            save_name = osp.join(save_path, 'replay_cloud_data',str(i),j.split('.')[0]+'.npy')
            np.save(save_name, proj_xyzd)
    ...
    for i in person_number :
        ...
        new_path = osp.join(save_path, 'replay_cloud_data', str(i))
        new_files = os.listdir(new_path)
        print(i,f' Org Data Count : {len(org_files)}  New Data Count : {len(new_files)} ==> {len(org_files)==len(new_files)}')
    ...
    for i in tqdm(person_number) :
        ...
        for j in files : 
            ...
            save_name = osp.join(save_path, 'paper_cloud_data', str(i),j.split('.')[0]+'.npy')
            np.save(save_name, proj_xyzd)
    ...
    for i in person_number :
        ...
        new_path = osp.join(save_path, 'paper_cloud_data',str(i))
        new_files = os.listdir(new_path)
        print(i,f' Org Data Count : {len(org_files)}  New Data Count : {len(new_files)} ==> {len(org_files)==len(new_files)}')
